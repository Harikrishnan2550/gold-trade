...
export default function ServicesHero() {
  ...
  return (
    <section className="relative pt-40 lg:pt-64 pb-20 lg:pb-32 overflow-hidden bg-[#050505] bg-floor-industrial border-b border-white/5">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-50"> {/* Increased section opacity */}
        <svg width="100%" height="100%" viewBox="0 0 1600 800" fill="none" preserveAspectRatio="none">
          
          <defs>
            {/* Bright Glow Filter for emission effect */}
            <filter id="heroNeonGlow" x="-25%" y="-25%" width="150%" height="150%">
              <feGaussianBlur stdDeviation="5" result="blur" />
              <feComposite in="SourceGraphic" in2="blur" operator="over" />
            </filter>
            
            <linearGradient id="servicesPulseBright" gradientUnits="userSpaceOnUse">
              <stop offset="0%" stopColor="transparent" />
              <stop offset="50%" stopColor="#FFFFFF" /> {/* High-intensity white core */}
      ...
      <Container className="relative z-10 text-center">
        ...
        >
          <Image src="/gold-nugget.png" alt="Bullion Asset" width={180} height={180} className="blur-[1px] lg:w-[240px]" />
        </motion.div>
        ...
        >
          Leveraging the strategic infrastructure of the SAIF Zone, 
          Zanora FZC engineers high-velocity physical trading channels 
          for global institutional liquidity.
        </motion.p>
        ...
        >
           ...
           <div className="flex flex-wrap justify-center gap-4 lg:gap-8 text-gray-700 font-nasal text-[8px] lg:text-[9px] uppercase tracking-[0.3em] lg:tracking-[0.4em]">
             ...
             <span className="text-white/20 hover:text-gold transition-colors duration-500 cursor-crosshair">999.9 PURITY Standard</span>
             <span className="hidden sm:block">•</span>
